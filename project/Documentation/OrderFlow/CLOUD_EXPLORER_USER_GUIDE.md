...
Если нужно поменять файл, папку, шаг цены или даты, сделайте это в основном
окне Order Flow, затем запустите новый расчёт в Explorer. Уже открытый результат
