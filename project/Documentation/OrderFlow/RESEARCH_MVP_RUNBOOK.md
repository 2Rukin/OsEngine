...
развернуть или переместить на другой монитор. Это тот же график: текущий участок,
...
sequenceDiagram
    ...
    Main->>Separate: Перенос панели и Show с владельцем Main
...
2. Во вкладке **«Адаптация и активность»** настройте только нужные модули.
...
3. Эпизоды и study независимо включаются в **«Эпизоды / VWAP / экстремумы»**
   и **«Исследование»**. Study выбирает один профиль и Cloud либо Episode trigger.
...
4. Нажмите **«Рассчитать каталог / исследование»**. Изменённые после расчёта
...
5. В **«Видимость»** настройте выбранный профиль и нажмите **«Применить видимость»**.
...
**«Реплей»**, **«Пауза»**, **«Один тик»** используют сохранённый run spec,
...
объекты. Итоговые таблицы и сравнение скрыты до возврата кнопкой **«История»**;
...
**«Открыть результат»** принимает manifest каталога или study, проверяет схемы
