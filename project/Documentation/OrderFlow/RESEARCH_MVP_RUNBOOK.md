...
повторной ручной проверкой владельца; [запись о прежней проблеме](TECHNICAL_DEBT.md)
закрыта. Offline-тесты сами по себе не проверяют фокус настоящих окон ОС.
